...
?>
				...
				<!-- Begin page heading -->
				<h1 class="page-heading">Payment <small> </small></h1>
				<!-- End page heading -->
					...
					<div class="the-box full no-border">
						<div class="table-responsive">
							<table class="table table-th-block table-primary">
													  ...
													  $dep=mysql_query("select * from payment where status ='success' and metode !='rolling' order  by tanggal desc");
