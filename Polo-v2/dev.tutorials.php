<div class="isotope" data-isotope-item-space="3" data-isotope-col="4" data-isotope-item=".post-item">
			...
			<!-- Blog image post-->
      <?php
      $a=mysqli_query($con, "select * from module,kategori where module.id_kategori=kategori.id_kategori order by id_module asc");
            ...
            <div class="post-item">
                ...
                <div class="post-content-details">
                    <div class="post-title">
                        <h5><a href="<?php echo $r['judul_seo']; ?>"><?php echo $r['judul']; ?></a></h5>
                    </div>
                    <div class="post-info">
