   ...
   <div class="table-responsive">
     <table class="table">
       ...
       <tbody>
         <?php
         $no=1;
          $categorylist=mysqli_query($con, "select * from link where category='youtube' ");

          while ($viewcategory=mysqli_fetch_array($categorylist)){
            echo "<tr>
                  <td>$no</td>
                  <td><a href='$viewcategory[link]' target='_blank'><i class='fa fa-youtube'></i> $viewcategory[name]</a></td>
